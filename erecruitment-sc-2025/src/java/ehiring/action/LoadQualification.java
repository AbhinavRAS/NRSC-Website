...
import ehiring.operation.EssentialQualificationOperation;
...
public class LoadQualification extends HttpServlet {
     ...
     */
            ...
            throws ServletException, IOException 
      {
        ...
        logMgr.accessLog("IN LoadQualification Servlet");

        ArrayList<String> formattedList = new EssentialQualificationOperation(emailLogId).loadEssentialQualOptions();
