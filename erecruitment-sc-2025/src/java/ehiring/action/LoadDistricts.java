...
public class LoadDistricts extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		logMgr.accessLog("IN LoadDistricts");

		logMgr.accessLog( "IN Load District Servlet");
		...
		ArrayList<String> formattedList = new StateDistrictOperation(emailLogId).loadDistrictNameOptions(state);

		try {
			logMgr.accessLog( "inside try of load state name");
			// System.out.println(CurrentDateTime.dateTime()+":"+"formattedList: " +
			// formattedList + "size : " + formattedList.size());
			...
			// System.out.println(CurrentDateTime.dateTime()+":"+"jsonResponse : " +
			// resultStr);
