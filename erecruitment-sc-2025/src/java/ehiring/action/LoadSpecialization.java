...
import ehiring.operation.SpecializationOperation;
...
public class LoadSpecialization extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		logMgr.accessLog("IN LoadSpecialization Servlet");

		ArrayList<String> formattedList = new SpecializationOperation(emailLogId).loadSpecializationOptions();
