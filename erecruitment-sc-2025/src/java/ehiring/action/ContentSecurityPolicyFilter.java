...
public class ContentSecurityPolicyFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        */
        ...
        // this.cspHeaders.add("X-Content-Security-Policy"); ChangeId: 2024011605 
        ...
        //cspPolicies.add("default-src 'unsafe-inline' 'self'"); //ChangeId: 2024011606
        cspPolicies.add("script-src 'self' 'nonce-erecruit2024010901'"); // 'nonce-erecruit2024010901' ChangeId: 2024010801 'unsafe-inline', 'unsafe-eval' removed
        cspPolicies.add("img-src 'self' data:"); 
        
        cspPolicies.add("frame-ancestors 'self'"); 
        cspPolicies.add("object-src 'none'"); // ChangeId: 2024010801 object-src added
        //cspPolicies.add("require-trusted-types-for 'script'"); // ChangeId: 2024010801 require-trusted-types-for added
