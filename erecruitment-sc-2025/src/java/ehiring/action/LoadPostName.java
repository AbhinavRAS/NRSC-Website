...
import ehiring.operation.PostNameOperation;
...
public class LoadPostName extends HttpServlet {
     ...
     */
        ...
        logMgr.accessLog("IN LoadPostName Servlet");

        ArrayList<String> formattedList = new PostNameOperation().loadPostNameOptions();
