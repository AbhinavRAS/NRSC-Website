 ...
 */
@WebServlet("/LoadNET")
public class LoadNET extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			logMgr.accessLog("Loading NET options");
			PrintWriter out = response.getWriter();
			ArrayList formattedList = new ArrayList();
			formattedList = new StateDistrictOperation(emailLogId).loadNET();
			logMgr.accessLog("inside try of load NET name");
