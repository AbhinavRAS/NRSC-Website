...
import ehiring.operation.EducationalBoardOperation;


/**
 * Servlet implementation class LoadBoard
 */
@WebServlet("/LoadEducationBoards")
public class LoadEducationBoards extends HttpServlet {
     ...
     */
        protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    		...
    		logMgr.accessLog("IN LoadEducationBoards");

      

        ArrayList<String> formattedList = new EducationalBoardOperation(emailLogId).loadBoardNameOptions();
