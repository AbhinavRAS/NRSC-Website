...
import ehiring.operation.DesirableQualificationOperation;
...
public class LoadDesirableQual extends HttpServlet {
     ...
     */
            ...
            throws ServletException, IOException 
      {
    	  ...
    	  String userId = java.net.URLDecoder.decode(request.getHeader("user"));
  		logMgr = LogManager.getInstance(userId);
  	     logMgr.accessLog("IN Desirable Qualification Servlet");

        ArrayList<String> formattedList = new DesirableQualificationOperation(userId).loadDesirableQualOptions();
