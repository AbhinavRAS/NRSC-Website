...
public class PasswordUtils {
	...
	public String ProtectUserPassword(String myPassword) {
	...
	public boolean VerifyProvidedPassword(String providedPassword ,String securePassword) {
	...
	/*	String password = "Admin_1234";
		...
		System.out.println("passwd:"+encryPassWd);*/
		
		PasswordUtils pu = new PasswordUtils();
		String encryPassWd=pu.generateOTP();
		System.out.println("OTP:"+encryPassWd);
	}
